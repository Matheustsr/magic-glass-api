...
import { SessionRoutes, EmployeeRoutes, CompanyRoutes, DepartmentRoutes } from '@routes';
...
export default class Routes {
	...
	setup() {
		...
		// this.routes.use('/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9/root', this.departmentRoutes.setup()); ROTA PARA CRIAR USUARIO ROOT e ter permissão em tudox
